...
/**
 * This activity displays question 6 of the quiz
 */
...
public class Question6Activity extends AppCompatActivity {
    ...
    public void checkAnswer() {
        RadioGroup radioGroup = findViewById(R.id.question6answer);
        if (radioGroup.getCheckedRadioButtonId() != -1) {
            RadioButton correctAnswer = findViewById(R.id.question6answer3);
    ...
    public void startTimer() {
        final TextView textView = findViewById(R.id.timer6);
